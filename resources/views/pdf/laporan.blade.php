   ...
   <div class="text-center">
      ...
      <div style="margin-left:6rem;">
         <span class="text-header text-bold text-danger">
            YAYASAN PENDAWA BOGOR <br>
               <span class="size2">SEKOLAH MENENGAH KEJURUAN (SMK) MEKANIKA</span> <br>
               
         </span>
         <span class="text-desc">JL. KOL. ENJO MARTADISASTRA. NO. 2 KEDUNG BADAK<br>TELP. & FAX 0251 - 8311071 BOGOR <br>Website <span class="underline">www.smkmekanika-bogor.sch.id</span> - Email <span class="underline">mekanikabogor@yahoo.co.id</span> </span>
      </div>    
      </div>
   <div>
   <!-- /header -->
